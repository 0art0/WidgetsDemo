...
import type { Name, RpcPtr } from '@leanprover/infoview';
export type Html = {
...
export declare function HtmlDisplay({ html }: {
    html: Html;
}): JSX.Element;
...
export default function TermDisplayWidgetRemote(props: TermDisplayWidgetRemoteProps): import("react/jsx-runtime").JSX.Element;
export {};
